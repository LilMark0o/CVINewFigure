...
void Tutorial02_Cube::CreateVertexBuffer()
{
    ...
    constexpr Vertex CubeVerts[10] =
        {
            {float3{-0.5f, -0.5f, -0.5f}, float4{1, 1, 1, 1}},
            {float3{+0.5f, -0.5f, -0.5f}, float4{1, 1, 1, 1}},
            {float3{-0.5f, -0.5f, +0.5f}, float4{1, 1, 1, 1}},
            {float3{+0.5f, -0.5f, +0.5f}, float4{1, 1, 1, 1}},

            {float3{0, 0, 0.000005f}, float4{1, 1, 0, 0.3f}},
            {float3{0, 0, -0.000005f}, float4{1, 1, 0, 0.3f}},

            {float3{-0.5f, 0.5f, -0.5f}, float4{0.5f, 0.5f, 0, 0.8f}},
            {float3{+0.5f, 0.5f, -0.5f}, float4{0.5f, 0.5f, 0, 0.8f}},
            {float3{-0.5f, 0.5f, +0.5f}, float4{0.5f, 0.5f, 0, 0.8f}},
            {float3{+0.5f, 0.5f, +0.5f}, float4{0.5f, 0.5f, 0, 0.8f}},
        };
...
void Tutorial02_Cube::CreateIndexBuffer()
{
    ...
    constexpr Uint32 Indices[] =
    {
        ...
        // primera pared completa
        1, 3, 4, 1, 4, 3,
        1, 4, 5, 1, 5, 4,
        
        
        // segunda pared completa
        4, 5, 0, 4, 0, 5,
        0, 2, 4, 0, 4, 2,
